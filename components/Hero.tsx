  ...
  return (
    <div className="hero-dots min-h-[calc(100vh-80px)] bg-linear-to-br from-primary-dark via-primary to-primary flex flex-col relative overflow-hidden pt-10 mt-[100px] mx-10 rounded-3xl max-[900px]:mt-20 max-[900px]:mx-3 max-[900px]:min-h-0 max-[480px]:mt-18 max-[480px]:mx-2 max-[480px]:pt-6 max-[480px]:rounded-2xl">
      ...
      <div className="flex-1 grid grid-cols-2 items-center max-w-[1200px] mx-auto px-15 py-20 pb-15 gap-10 relative z-2
        ...
        <div>
          <h1 className="font-display text-[clamp(38px,4.8vw,62px)] font-extrabold text-white leading-[1.06] tracking-[-2px] mb-5.5 max-[480px]:text-[32px] max-[480px]:tracking-[-1px] max-[480px]:mb-4">
          ...
          <div className="flex gap-3.5 flex-wrap mb-12 max-[900px]:justify-center max-[480px]:flex-col max-[480px]:items-center">
            ...
            <a href="#how-works" className="font-display text-sm font-medium text-white bg-white/12 border-[1.5px] border-white/30 rounded-full py-3.5 px-[30px] cursor-pointer backdrop-blur-[10px] transition-colors no-underline inline-block hover:bg-white/20 max-[480px]:w-full max-[480px]:text-center">
              Voir la démo
            </a>
          </div>
        ...
        <div className="flex justify-center items-center relative max-[900px]:hidden">
          <div className="relative flex items-end justify-center">
            ...
            {/* Left badge */}
            <div className="absolute -left-15 top-[30%] z-3 bg-white rounded-[14px] py-2.5 px-3.5 shadow-[0_8px_32px_rgba(0,87,183,0.25)] flex items-center gap-2 animate-[badgeFloat_3.5s_ease-in-out_infinite_0.5s]">
            ...
            {/* Right badge */}
            <div className="absolute -right-[50px] top-[55%] z-3 bg-white rounded-[14px] py-2.5 px-3.5 shadow-[0_8px_32px_rgba(0,87,183,0.25)] flex items-center gap-2 animate-[badgeFloat_3.5s_ease-in-out_infinite_1.2s]">
